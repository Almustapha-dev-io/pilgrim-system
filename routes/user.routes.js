...
const { User, validate, validateForUpdate } = require('../models/user.model');
...
router.post('/', [auth, superAdmin], async (req, res) => {
    ...
    let user;
    user = await User.findOne({ localGovernment: localGovernmentId });
...
router.put('/:id', [auth, superAdmin, validateObjectId], async (req, res) => {
    ...
    user = await User.findByIdAndUpdate(req.params.id, {
        $set: { name, email, role: roleId, localgovernment: localGovernmentId }
