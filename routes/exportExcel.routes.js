...
router.get('/pilgrims', async (req, res) => {
    ...
    worksheet.columns = [
        ...
        { header: 'Marital Status', key: 'personalDetails.maritalStatus', width: 10 },
        { header: 'Home Address', key: 'personalDetails.homeAddress', width: 10 },
        { header: 'State of origin', key: 'personalDetails.stateOfOrigin.name', width: 10 },
        ...
        { header: 'Next of kin relationship', key: 'nextOfKinDetails.relationship', width: 10 },
        { header: 'Next of kin address', key: 'nextOfKinDetails.address', width: 10 },
        { header: 'Next of kin phone', key: 'nextOfKinDetails.phone', width: 10 },

        { header: 'Mahrim', key: 'mahrimDetails.fullName', width: 10 },
        { header: 'Mahrim relationship', key: 'mahrimDetails.relationship', width: 10 },
        ...
        { header: 'Passport number', key: 'passportDetails.passportNumber', width: 10 },
        { header: 'Passport place of issue', key: 'passportDetails.placeOfIssue', width: 10 },
        { header: 'Passport issue date', key: 'passportDetails.dateOfIssue', width: 10 },
        { header: 'Passport expiry date', key: 'passportDetails.expiryDate', width: 10 },
    ...
    const flattened = pilgrims.map(p => ({
        ...
        'personalDetails.localGovOfOrigin.name': p.personalDetails.localGovOfOrigin.name,
...
router.get('/allocations/:type', async (req, res) => {
    ...
    const workbook = new excelJs.Workbook();
    const worksheet = workbook.addWorksheet(`ALLOCATIONS - ${req.params.type.toUpperCase()}`);
    worksheet.columns = [
        { header: 'Pilgrim Surname', key: 'pilgrim.personalDetails.surname', width: 10 },
        { header: 'Pilgrim Other Names', key: 'pilgrim.personalDetails.otherNames', width: 10 },
        { header: 'Pilgrim Home Address', key: 'pilgrim.personalDetails.homeAddress', width: 10 },
        { header: 'Pilgrim DOB', key: 'pilgrim.personalDetails.dateOfBirth', width: 10 },
        { header: 'Pilgrim Phone', key: 'pilgrim.personalDetails.phone', width: 10 },
        { header: 'Pilgrim Email', key: 'pilgrim.personalDetails.email', width: 10 },
        { header: 'Pilgrim Phone II', key: 'pilgrim.personalDetails.alternatePhone', width: 10 },
       
        { header: 'Pilgrim Passport type', key: 'pilgrim.passportDetails.passportType', width: 10 },
        { header: 'Pilgrim Passport number', key: 'pilgrim.passportDetails.passportNumber', width: 10 },
        { header: 'Pilgrim Passport place of issue', key: 'pilgrim.passportDetails.placeOfIssue', width: 10 },
        { header: 'Pilgrim Passport issue date', key: 'pilgrim.passportDetails.dateOfIssue', width: 10 },
        { header: 'Pilgrim Passport expiry date', key: 'pilgrim.passportDetails.expiryDate', width: 10 },
        ...
        { header: 'Allocation Number', key: 'enrollmentAllocationNumber', width: 10 },
    ...
    const flattened = allocations.map(p => ({
        ...
        'pilgrim.personalDetails.homeAddress': p.pilgrim.personalDetails.homeAddress,
        'pilgrim.personalDetails.dateOfBirth': p.pilgrim.personalDetails.dateOfBirth,
        ...
        'pilgrim.personalDetails.alternatePhone': p.pilgrim.personalDetails.alternatePhone,
        
        'pilgrim.passportDetails.passportType': p.pilgrim.passportDetails.passportType,
        'pilgrim.passportDetails.passportNumber': p.pilgrim.passportDetails.passportNumber,
        'pilgrim.passportDetails.placeOfIssue': p.pilgrim.passportDetails.placeOfIssue,
        'pilgrim.passportDetails.dateOfIssue': p.pilgrim.passportDetails.dateOfIssue,
